...
#pragma config(Motor,  port1,           leftLinkMotor, tmotorVex393_HBridge, openLoop, reversed, driveLeft)
#pragma config(Motor,  port2,           dustPanMotor,  tmotorVex393_MC29, openLoop, driveLeft)
...
#pragma config(Motor,  port10,          rightLinkMotor, tmotorVex393_HBridge, openLoop, driveRight)
